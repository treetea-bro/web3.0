...
const commonStyles =
  "h-[70px] sm:px-0 px-2 sm:min-w-[100px] flex justify-center items-center border-[0.5px] border-gray-400";
    ...
    <div className="flex w-full justify-center items-center">
      <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
        <div className="flex flex-col flex-1 justify-start mf:mr-10">
          ...
          {!currentAccount && (
            <button
              ...
              className="flex flex-row justify-center items-center my-5 bg-[#2952e3] hover:bg[#2546bd] rounded-full cursor-pointer"
            >
        ...
        <div className="flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10">
          <dir className="p-3 justify-end items-start flex-col rounded-xl h-40 sm:w-72 w-full my-5 eth-card white-glassmorphism">
